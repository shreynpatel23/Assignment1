...
if (isset($_POST['submit'])) {
  ...
  $sql = "UPDATE Authors 
          SET full_name = '". mysqli_real_escape_string($connect, $fullName) ."', 
          nationality = '". mysqli_real_escape_string($connect, $nationality) ."', 
          biography = '". mysqli_real_escape_string($connect, $bio) ."', 
          language = '". mysqli_real_escape_string($connect, $language) ."', 
          birthplace = '". mysqli_real_escape_string($connect, $birthplace) ."' 
